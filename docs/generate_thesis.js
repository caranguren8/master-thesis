...
const ch2 = [
  ...
  para([
    ...
    new TextRun({ text: "Candidates whose party barely wins a marginal seat are more likely to reappear on the party list in the subsequent election (extensive margin incumbency advantage).", font: "Arial", size: 24 })
  ]),
  para("Rationale: Winning representation provides organizational resources, media visibility, and demonstrated electoral viability that reduce the costs and increase the expected benefits of contesting the next election. Candidates from parties that lose their last seat in a province may be more likely to be dropped from the list or to exit politics due to reduced perceived viability."),
  para([
    new TextRun({ text: "H2: ", bold: true, font: "Arial", size: 24 }),
    new TextRun({ text: "Candidates whose party barely wins a marginal seat are more likely to win a seat in the subsequent election (intensive margin incumbency advantage).", font: "Arial", size: 24 })
  ]),
  para("Rationale: Beyond simply running again, incumbent candidates and their parties may attract more votes through visibility, policy influence, and voter loyalty, translating the extensive margin advantage into actual seat gains."),
  para([
    new TextRun({ text: "H3: ", bold: true, font: "Arial", size: 24 }),
...
const ch6 = [
    ...
    return new Table({
      ...
      rows: [
        ...
        new TableRow({ children: [
          ...
          dataCell("0.053", colW[1], "right"),
          dataCell("0.285***", colW[2], "right"),
          dataCell("(0.047)", colW[3], "right"),
          dataCell("0.292***", colW[4], "right"),
          dataCell("(0.048)", colW[5], "right"),
          dataCell("0.979***", colW[6], "right"),
        ]}),
        new TableRow({ children: [
          dataCell("Wins next", colW[0], "left"),
          dataCell("0.018", colW[1], "right"),
          dataCell("0.262**", colW[2], "right"),
          dataCell("(0.081)", colW[3], "right"),
          dataCell("0.266**", colW[4], "right"),
  ...
  emptyPara(),
  para("The results provide strong evidence for an incumbency advantage in Spain\u2019s PR system. The sharp RDD estimate for the probability of running in the next election is 0.285 (SE = 0.047, p < 0.001), indicating that parties barely winning a marginal seat are approximately 28.5 percentage points more likely to contest the subsequent election. The effect on winning a seat in the next election is 0.262 (SE = 0.081, p = 0.001)."),
