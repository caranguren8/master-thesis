...
const ch5 = [
  ...
  para("The full dataset comprises 2,412 party-province-election observations within the analysis window (running variable between \u22120.05 and +0.05). After linking outcomes to the subsequent election, the estimation sample for the \u201Cruns next\u201D outcome contains 2,118 observations, and the \u201Cwins next\u201D outcome contains the same 2,118 observations with non-missing outcomes."),
