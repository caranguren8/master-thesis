...
const ch4 = [
  ...
  para("The key identifying assumption of the RDD is that the conditional expectation of potential outcomes is continuous at the cutoff (Hahn, Todd, and Van der Klaauw, 2001). Under this assumption, any discontinuity in the observed outcome at the cutoff can be attributed to the causal effect of treatment. The local average treatment effect (LATE) is identified by comparing outcomes of units just above and just below the cutoff, within an appropriately chosen bandwidth. Angrist and Pischke (2009, Chapter 6) provide an accessible treatment of the RDD framework and its relationship to instrumental variables estimation, and Imbens and Lemieux (2008) offer practical guidance on implementation choices including bandwidth selection, kernel weighting, and specification testing."),
...
const ch10 = [
  ...
  para("Angrist, J. D., & Pischke, J.-S. (2009). Mostly harmless econometrics: An empiricist\u2019s companion. Princeton University Press."),
